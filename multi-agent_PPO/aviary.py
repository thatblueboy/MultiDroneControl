...
class Aviary(BaseMultiagentAviary):
    """ 
    to do
    """
    ...
    def __init__(self,
                 ...
                 initial_xyzs=np.array([[0, 0, 0.5], [1,1,0.5]]),
                 initial_rpys=np.array([[0, 0, 0], [0, 0, 0]]),
                 obstaclePositions = np.array([]),
    ...
    def _computeReward(self):
        ...
        """rewards[0] = np.lingalg.norm(prev_pos-np.array([2, 2, 0.5])) - np.linalg.norm(pos1-np.array([2, 2, 0.5]))
        rewards[1] = np.lingalg.norm(prev_pos-np.array([2, 2, 0.5])) - np.linalg.norm(pos1-np.array([2, 2, 0.5]))"""
        """
    ...
    def _computeDone(self):
        ...
        if np.linalg.norm(pos1-np.array([2, 2, 0.5]))<0.1: 
            done[0] = True
